...
public final class Base64Util {
    ...
    private final static byte[] DECODABET = {-9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 0 - 8
            ...
            /*
             * ,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9, // Decimal 128 - 139 -9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9, // Decimal
     ...
     * @return the decoded data
     */
    public static byte[] decodeWebSafe(byte[] source) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
    public static byte[] decode(byte[] source, int off, int len) throws UnsupportedEncodingException {
     ...
     * @return decoded data
     */
    public static byte[] decodeWebSafe(byte[] source, int off, int len) throws UnsupportedEncodingException {
     ...
     * @return decoded data
     */
    public static byte[] decode(byte[] source, int off, int len, byte[] decodabet) throws UnsupportedEncodingException {
        int len34 = len * 3 / 4;
                ...
                if (sbiDecode >= EQUALS_SIGN_ENC) {
                    ...
                    if (sbiCrop == EQUALS_SIGN) {
                        ...
                        if (b4Posn == 0 || b4Posn == 1) {
                            throw new UnsupportedEncodingException("invalid padding byte '=' at byte offset " + i);
                            ...
                            throw new UnsupportedEncodingException("encoded value has invalid trailing byte");
                        }
                        break;
                    }
    ...
    // 自定义encode转小写，为了兼容.net
    public static String LowerCaseUrlEncode(String strValue, String codeType) throws Exception {
        char[] temp = java.net.URLEncoder.encode(strValue, codeType).toCharArray();
    ...
    // 自定义encode转小写，为了兼容.net
    public static String LowerCaseUrlDecode(String s, String codeType) throws Exception {
        char[] temp = java.net.URLDecoder.decode(s, codeType).toCharArray();
        for (int i = 0; i < temp.length - 2; i++) {
            if (temp[i] == '%') {
                temp[i + 1] = Character.toLowerCase((temp[i + 1]));
                temp[i + 2] = Character.toLowerCase(temp[i + 2]);
